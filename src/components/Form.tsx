    ...
    return (
        <form className="flex p-4 bg-gray-200" onSubmit={handleSubmit}>
            <div className="flex w-full items-end">
                <textarea
                    ref={textareaRef}
                    className="flex-1 mr-2 disabled:opacity-50 rounded-md border-2 border-gray-300 bg-white py-2 px-4 text-sm placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 text-black resize-none overflow-hidden"
